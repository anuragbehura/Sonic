...
export async function getSongByLocalUri(
    localUri: string
): Promise<Song | null> {
...
export async function updateSongLocalUri(
    id: string,
...
export async function updateSongPinned(
    id: string,
    isPinned: boolean
): Promise<void> {
...
export async function updateSongLastPlayed(
    id: string
): Promise<void> {
...
export async function updateSongCloudKey(
    id: string,
    cloudKey: string
): Promise<void> {
